...
- [ ] Create island tamplate (you can create land tamplate you can import as a layer on the map) 
- [ ] Import countries (import only one or several countries, separated by sea) 
- [ ] Auto nation spawn (based on the geopolitical data from open street maps ) 
